...
**ADDED**: Four new technical indicators based on 50-day and 200-day moving averages.
...
- ✅ Moving averages computed on lagged prices only (T-1, T-2, ..., T-50/T-200)
- ✅ At time T, MA uses prices from T-1 backwards (no future data)
...
**Use Cases**:
- **Trend identification**: `above_200dma` = 1 indicates stock in long-term uptrend
- **Momentum strength**: `return_50dma = 15%` means strong positive momentum
- **Mean reversion**: Stocks far from MA (high absolute return_*dma) may revert
- **Support/resistance**: MAs often act as dynamic support/resistance levels

**Impact**:
- ✅ Adds 4 classic technical indicators used by traders worldwide
- ✅ Total feature count increases from ~294 → 298 features
- ✅ Zero look-ahead bias (production-safe for live trading)
- ✅ Feature descriptions automatically logged during training

**Feature Descriptions Added** (lines 866-869):
```python
